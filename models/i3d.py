...
class InceptionModule(nn.Module):
    def __init__(self, in_channels, out_channels, name, activation_fn):
...
class InceptionI3d(nn.Module):
    ...
    def __init__(
        ...
        self.end_points[end_point] = InceptionModule(
            192, [64, 96, 128, 16, 32, 32], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_3c"
        self.end_points[end_point] = InceptionModule(
            256, [128, 128, 192, 32, 96, 64], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_4b"
        self.end_points[end_point] = InceptionModule(
            128 + 192 + 96 + 64, [192, 96, 208, 16, 48, 64], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_4c"
        self.end_points[end_point] = InceptionModule(
            192 + 208 + 48 + 64, [160, 112, 224, 24, 64, 64], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_4d"
        self.end_points[end_point] = InceptionModule(
            160 + 224 + 64 + 64, [128, 128, 256, 24, 64, 64], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_4e"
        self.end_points[end_point] = InceptionModule(
            128 + 256 + 64 + 64, [112, 144, 288, 32, 64, 64], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_4f"
        self.end_points[end_point] = InceptionModule(
            112 + 288 + 64 + 64, [256, 160, 320, 32, 128, 128], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_5b"
        self.end_points[end_point] = InceptionModule(
            256 + 320 + 128 + 128, [256, 160, 320, 32, 128, 128], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
        ...
        end_point = "Mixed_5c"
        self.end_points[end_point] = InceptionModule(
            256 + 320 + 128 + 128, [384, 192, 384, 48, 128, 128], name + end_point, activation_fn=activation_func,
        )
        if self._final_endpoint == end_point:
            return
...
if __name__ == "__main__":
    ...
    dummy_input = torch.randn(32, 3, 16, 224, 224)
    output = model(dummy_input)
    print(output["logits"].shape)
    print(output["embds"].squeeze(-1).squeeze(-1).squeeze(-1).shape)
